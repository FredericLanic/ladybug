...
public class KinematicLadybugDeath {
	...
	private List<PicturesEnum> lstPictures		 = new ArrayList<>(Arrays.asList(PicturesEnum.LADYBUG_UP_FULL,
	        PicturesEnum.LADYBUG_UP_1, PicturesEnum.LADYBUG_UP_2, PicturesEnum.LADYBUG_UP_3, PicturesEnum.LADYBUG_UP_4,
	        PicturesEnum.LADYBUG_UP_5, PicturesEnum.LADYBUG_UP_6, PicturesEnum.LADYBUG_UP_7, PicturesEnum.LADYBUG_UP_8,
	        PicturesEnum.LADYBUG_UP_9, PicturesEnum.EMPTY));
	@Setter
