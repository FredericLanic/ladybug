 ...
 *
 */
public final class GameMainConstants {
	// taille d'un block
	...
	public static final int PRESENTATION_LEVEL = 3;
	...
	// 48 (taille d'un BLOCK_SIZE) pour que le programme puisse détecter le
