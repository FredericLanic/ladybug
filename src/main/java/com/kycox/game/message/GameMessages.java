...
public enum GameMessages {
	...
	ONE_PLAYER_MODE("single player mode"), SOUND_ACTIVE("sound activated"), SOUND_OFF("sound off"),
	TWO_PLAYERS_MODE("two player mode"), XBOX_GHOST_CONNECTION("xboxone ghost connected"),
